...
//    public int WIDTH = 9;
    ...
    public void getDimensions(){
        try{
            this.reader = new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("components/map/TrackFile.txt")));
            this.LENGTH = Character.getNumericValue(reader.readLine().charAt(0));
            this.WIDTH = Character.getNumericValue(reader.readLine().charAt(0));
        } catch (IOException e){
